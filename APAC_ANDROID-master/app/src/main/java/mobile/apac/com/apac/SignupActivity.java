...
/**
 * Created by qianyingji on 11/14/15.
 */
...
public class SignupActivity extends AppCompatActivity {
    ...
    @InjectView(R.id.input_birthdate) EditText _birthdateText;
    ...
    public void signup() {
        ...
        //TODO:fix birthdate
        //String birthdate = _birthdateText.getText().
    ...
    public boolean validate() {
        ...
        if (username.isEmpty() || username.length() < 2) {
            _usernameText.setError("at least 2 characters");
            valid = false;
        } else {
